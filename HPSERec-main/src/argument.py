...
def parse_args():
    ...
    parser.add_argument('--pareto_rule', default=0.8, type=float, help="pareto")

    parser.add_argument('--pretrain_embedding_epoch', '-e', default=None, type=int, help="pretrain_embedding_epoch")
    parser.add_argument('--pretrain_alpha', '-pa', default=1.0, type=float, help="pretrain_alpha")
