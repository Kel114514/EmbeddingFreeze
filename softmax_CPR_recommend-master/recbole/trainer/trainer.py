...
class Trainer(AbstractTrainer):
    ...
    def evaluate(self, eval_data, load_best_model=True, model_file=None, show_progress=False):
        ...
        if load_best_model:
            ...
            WeightsUnpickler error: Unsupported global: GLOBAL recbole.config.configurator.Config was not an allowed global by default. 
            Please use `torch.serialization.add_safe_globals([recbole.config.configurator.Config])` or the `torch.serialization.safe_globals([recbole.config.configurator.Config])` 
            context manager to allowlist this global if you trust this class/function.
            '''
            # Set weights_only to True, but should work for False
